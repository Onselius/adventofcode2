...
public class Dec10Test {
    private final Dec10 base_class = new Dec10();

    @Test
    void testPart1()
    {
        URL url  = getClass().getResource("test/test10.txt");
    ...
    void testPart1Input()
    {
        URL url  = getClass().getResource("input/input10.txt");
        List<String> lines = ReadFile.getTextFromFile(url.getPath());
        base_class.setLines(lines);
