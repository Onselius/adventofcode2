...
public class Dec19Test {
    private final Dec19 base_class = new Dec19();

    @Test
    void testPart1()
    {
        URL url  = getClass().getResource("test/test19.txt");
    ...
    void testPart1Input()
    {
        URL url  = getClass().getResource("input/input19.txt");
        List<String> lines = ReadFile.getTextFromFile(url.getPath());
        base_class.setLines(lines);
