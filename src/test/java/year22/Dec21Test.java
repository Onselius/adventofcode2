...
public class Dec21Test {
    private final Dec21 base_class = new Dec21();

    @Test
    void testPart1()
    {
        URL url  = getClass().getResource("test/test21.txt");
    ...
    void testPart1Input()
    {
        URL url  = getClass().getResource("input/input21.txt");
        List<String> lines = ReadFile.getTextFromFile(url.getPath());
        base_class.setLines(lines);
