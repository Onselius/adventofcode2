...
public class Dec25Test {
    private final Dec25 base_class = new Dec25();

    @Test
    void testPart1()
    {
        URL url  = getClass().getResource("test/test25.txt");
    ...
    void testPart1Input()
    {
        URL url  = getClass().getResource("input/input25.txt");
        List<String> lines = ReadFile.getTextFromFile(url.getPath());
        base_class.setLines(lines);
