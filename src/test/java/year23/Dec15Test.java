...
public class Dec15Test {
    private final Dec15 base_class = new Dec15();

    @Test
    void testPart1()
    {
        URL url  = getClass().getResource("test/test15.txt");
    ...
    void testPart1Input()
    {
        URL url  = getClass().getResource("input/input15.txt");
        List<String> lines = ReadFile.getTextFromFile(url.getPath());
        base_class.setLines(lines);
