...
public class Dec20Test {
    private final Dec20 base_class = new Dec20();

    @Test
    void testPart1()
    {
        URL url  = getClass().getResource("test/test20.txt");
    ...
    void testPart1Input()
    {
        URL url  = getClass().getResource("input/input20.txt");
        List<String> lines = ReadFile.getTextFromFile(url.getPath());
        base_class.setLines(lines);
