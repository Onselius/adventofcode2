...
public class Dec23Test {
    private final Dec23 base_class = new Dec23();

    @Test
    void testPart1()
    {
        URL url  = getClass().getResource("test/test23.txt");
    ...
    void testPart1Input()
    {
        URL url  = getClass().getResource("input/input23.txt");
        List<String> lines = ReadFile.getTextFromFile(url.getPath());
        base_class.setLines(lines);
