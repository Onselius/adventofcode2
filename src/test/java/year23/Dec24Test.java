...
public class Dec24Test {
    private final Dec24 base_class = new Dec24();

    @Test
    void testPart1()
    {
        URL url  = getClass().getResource("test/test24.txt");
    ...
    void testPart1Input()
    {
        URL url  = getClass().getResource("input/input24.txt");
        List<String> lines = ReadFile.getTextFromFile(url.getPath());
        base_class.setLines(lines);
